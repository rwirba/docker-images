...
# Environment variables for reusable component versions
ENV NETTY_VERSION=4.1.111.Final \
...
RUN wget https://repo1.maven.org/maven2/io/netty/netty-all/${NETTY_VERSION}/netty-all-${NETTY_VERSION}.jar -O /usr/share/java/kafka/netty-all.jar && \
    ...
    wget https://repo1.maven.org/maven2/org/apache/mina/mina-core/2.2.4/mina-core-2.2.4.jar -O /usr/share/java/kafka/mina-core.jar && \
...
# 4. Final cleanup to remove cache and leftover vulnerabilities
